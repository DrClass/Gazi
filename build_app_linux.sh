...
JAVA_VERSION=17
MAIN_JAR="gazi-$PROJECT_VERSION.jar"
...
detected_modules=`$JAVA_HOME/bin/jdeps \
  ...
  --class-path "target/installer/input/libs/*" \
    target/classes/io/github/drclass/gazi/Gazi.class`
...
--name Gazi \
--main-class io.github.drclass.gazi.Gazi \
--main-jar ${MAIN_JAR} \
--java-options -Xmx2048m \
--runtime-image target/java-runtime \
--icon src/main/logo/linux/ducky.png \
